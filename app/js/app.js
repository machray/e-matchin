...
function _init() {
	...
	$.AdminLTE.pushMenu = {
		activate: function(toggleBtn) {
			...
			$(".content-wrapper").click(function() {
				...
				if ($(window).width() <= (screenSizes.sm - 1) && $("body").hasClass(
						"sidebar-open")) {
					$("body").removeClass('sidebar-open');
				}
			});
			...
			if ($.AdminLTE.options.sidebarExpandOnHover || ($('body').hasClass(
					'fixed') && $('body').hasClass('sidebar-mini'))) {
				this.expandOnHover();
			}
		...
		expandOnHover: function() {
			...
			$('.main-sidebar').hover(function() {
				if ($('body').hasClass('sidebar-mini') && $("body").hasClass(
						'sidebar-collapse') && $(window).width() > screenWidth) {
					_this.expand();
				}
			}, function() {
				if ($('body').hasClass('sidebar-mini') && $('body').hasClass(
						'sidebar-expanded-on-hover') && $(window).width() > screenWidth) {
					_this.collapse();
				}
			});
		},
	...
	$.AdminLTE.tree = function(menu) {
		...
		$("li a", $(menu)).on('click', function(e) {
			...
			else if ((checkElement.is('.treeview-menu')) && (!checkElement.is(
					':visible'))) {
				//Get the parent menu
	...
	$.AdminLTE.controlSidebar = {
		...
		activate: function() {
			...
			btn.on('click', function(e) {
				...
				if (!sidebar.hasClass('control-sidebar-open') && !$('body').hasClass(
